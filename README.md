...
Seu desafio é construir a o card de lançamento do Nike Air seguindo o layout.
...
- Você deverá criar o Card de lançamento do Tênis Nike Air podendo ser apenas uma página estática com HTML e CSS.
- Deve seguir e criar as animações, efeitos, hover o mais fiel com o modelo e layout fornecido.
- Seu layout deve ser responsivo a diferentes tamanhos de telas como Desktop, Tablet e Celular.
